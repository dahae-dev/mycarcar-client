        ...
        <div>
          ...
          <div className="estimate_form_client_infomation1">
            ...
            <div className="estimate_form_info_content">
              ...
              개인사업자등록증 사본 / 신분증 사본 / 자격증 사본 / 부과세과세증명서 1통 / 재직증명서 1부 / 원청징수영수증
              / 인감도장
            </div>
          </div>
          ...
          <div className="estimate_form_client_infomation1">
            ...
            <div className="estimate_form_info_content">
              법인등기부등본 1통 / 법인인감증명서 2통 / 법인사업자등록증 사본 / 최근년도재무제표 1부 / 법인 자동이체통장
              사본 / 대표이사 주민등록등본 1통 / 대표이사 인감증명서 2통 / 대표이사 재산세증명서 1통 / 대표이사 신분증
              사본 / 법인 주주명부 / 인감도장
            </div>
          </div>
        </div>
